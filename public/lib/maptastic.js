// Maptastic — projection-mapping calibration UI.
// MIT, originally https://github.com/glowbox/maptasticjs by Glowbox / Aaron Koblin.
// Ported to ES-module form for the 3d-video-gen project — only change is the
// `export default` at the bottom of the file. The interactive behavior is
// identical to upstream. Key bindings (when config mode active):
//   SHIFT-Space  : toggle edit mode
//   click+drag   : select / move corners or quads
//   SHIFT+drag   : 10× precision
//   ALT+drag     : rotate / scale selected quad
//   arrow keys   : move; +shift for 10px; +alt for rotate/scale
//   s / c / r    : solo / crosshairs / rotate 90°
