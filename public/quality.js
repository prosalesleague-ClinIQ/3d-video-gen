...
export const PRESETS = {
  low:   { dpr: 1,   renderScale: 0.75, shadowMap: 1024, ssgi: false, hbao: false, traa: false, smaa: true,  bloomMip: false, sharpen: 0.4 },
  med:   { dpr: 1.5, renderScale: 0.9,  shadowMap: 1024, ssgi: false, hbao: true,  traa: false, smaa: true,  bloomMip: true,  sharpen: 0.3 },
  high:  { dpr: 2,   renderScale: 1.0,  shadowMap: 2048, ssgi: true,  hbao: true,  traa: true,  smaa: true,  bloomMip: true,  sharpen: 0.25 },
  ultra: { dpr: 3,   renderScale: 1.0,  shadowMap: 4096, ssgi: true,  hbao: true,  traa: true,  smaa: true,  bloomMip: true,  sharpen: 0.2 },
};
